...
CreateThread(function()
	pcall(function()
		local playerCols = exports.oxmysql:query_async("SHOW COLUMNS FROM playerdata LIKE 'dvalue'")
		if not playerCols or #playerCols == 0 then
			local infoCol = exports.oxmysql:query_async("SHOW COLUMNS FROM playerdata LIKE 'Information'")
			if infoCol and #infoCol > 0 then
				exports.oxmysql:query_async("ALTER TABLE playerdata CHANGE COLUMN `Name` `dkey` varchar(100) NOT NULL")
				exports.oxmysql:query_async("ALTER TABLE playerdata CHANGE COLUMN `Information` `dvalue` longtext DEFAULT NULL")
			else
				exports.oxmysql:query_async("ALTER TABLE playerdata ADD COLUMN IF NOT EXISTS `dkey` varchar(100) NOT NULL")
				exports.oxmysql:query_async("ALTER TABLE playerdata ADD COLUMN IF NOT EXISTS `dvalue` longtext DEFAULT NULL")
			end
		end
	end)

	pcall(function()
		local name2Col = exports.oxmysql:query_async("SHOW COLUMNS FROM characters LIKE 'name2'")
		if not name2Col or #name2Col == 0 then
			local lastnameCol = exports.oxmysql:query_async("SHOW COLUMNS FROM characters LIKE 'Lastname'")
			if lastnameCol and #lastnameCol > 0 then
				exports.oxmysql:query_async("ALTER TABLE characters CHANGE COLUMN `Lastname` `name2` varchar(50) DEFAULT 'Indigente'")
			else
				exports.oxmysql:query_async("ALTER TABLE characters ADD COLUMN `name2` varchar(50) DEFAULT 'Indigente'")
			end
		end
	end)

	pcall(function()
		local entityCols = exports.oxmysql:query_async("SHOW COLUMNS FROM entitydata LIKE 'dvalue'")
		if not entityCols or #entityCols == 0 then
			local infoCol = exports.oxmysql:query_async("SHOW COLUMNS FROM entitydata LIKE 'Information'")
			if infoCol and #infoCol > 0 then
				exports.oxmysql:query_async("ALTER TABLE entitydata CHANGE COLUMN `Name` `dkey` varchar(100) NOT NULL")
				exports.oxmysql:query_async("ALTER TABLE entitydata CHANGE COLUMN `Information` `dvalue` longtext DEFAULT NULL")
			else
				exports.oxmysql:query_async("ALTER TABLE entitydata ADD COLUMN IF NOT EXISTS `dkey` varchar(100) NOT NULL")
				exports.oxmysql:query_async("ALTER TABLE entitydata ADD COLUMN IF NOT EXISTS `dvalue` longtext DEFAULT NULL")
			end
		end
	end)

	pcall(function()
		local wlCol = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'whitelist'")
		if not wlCol or #wlCol == 0 then
			local wlUpper = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'Whitelist'")
			if wlUpper and #wlUpper > 0 then
				exports.oxmysql:query_async("ALTER TABLE accounts CHANGE COLUMN `Whitelist` `whitelist` tinyint(1) NOT NULL DEFAULT 0")
			end
		end
		local chCol = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'chars'")
		if not chCol or #chCol == 0 then
			local chUpper = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'Characters'")
			if chUpper and #chUpper > 0 then
				exports.oxmysql:query_async("ALTER TABLE accounts CHANGE COLUMN `Characters` `chars` int(10) NOT NULL DEFAULT 1")
			end
		end
		local gmCol = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'gems'")
		if not gmCol or #gmCol == 0 then
			local gmUpper = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'Gemstone'")
			if gmUpper and #gmUpper > 0 then
				exports.oxmysql:query_async("ALTER TABLE accounts CHANGE COLUMN `Gemstone` `gems` int(20) NOT NULL DEFAULT 0")
			end
		end
		local prCol = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'premium'")
		if not prCol or #prCol == 0 then
			local prUpper = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'Premium'")
			if prUpper and #prUpper > 0 then
				exports.oxmysql:query_async("ALTER TABLE accounts CHANGE COLUMN `Premium` `premium` int(20) NOT NULL DEFAULT 0")
			end
		end
		local rpCol = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'rolepass'")
		if not rpCol or #rpCol == 0 then
			local rpUpper = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'Rolepass'")
			if rpUpper and #rpUpper > 0 then
				exports.oxmysql:query_async("ALTER TABLE accounts CHANGE COLUMN `Rolepass` `rolepass` int(20) NOT NULL DEFAULT 0")
			end
		end
		local dcCol = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'discord'")
		if not dcCol or #dcCol == 0 then
			local dcUpper = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'Discord'")
			if dcUpper and #dcUpper > 0 then
				exports.oxmysql:query_async("ALTER TABLE accounts CHANGE COLUMN `Discord` `discord` varchar(50) NOT NULL DEFAULT '0'")
			end
		end
		local lcCol = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'license'")
		if not lcCol or #lcCol == 0 then
			local lcUpper = exports.oxmysql:query_async("SHOW COLUMNS FROM accounts LIKE 'License'")
			if lcUpper and #lcUpper > 0 then
				exports.oxmysql:query_async("ALTER TABLE accounts CHANGE COLUMN `License` `license` varchar(50) NOT NULL DEFAULT '0'")
			end
		end
	end)

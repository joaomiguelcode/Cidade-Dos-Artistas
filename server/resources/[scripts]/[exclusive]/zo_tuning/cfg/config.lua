menuTuning = {
    comando = "remap", 
    permissoesAcessarMenu = {"Rockstar","Remap"},
    itensObrigatorioAcessar = {}, -- { "notebook" },

    itensObrigatorioInstalarModulo = {}, -- { "chavefenda" },
    permissoesInstalarModulo = {"Rockstar","Remap"}, -- { "mecanico.permissao" },
    
    itensObrigatorioRemoverModulo = {}, -- { "chavefenda" },
    permissoesRemoverModulo = {"Rockstar","Remap"}, -- { "mecanico.permissao" },
}

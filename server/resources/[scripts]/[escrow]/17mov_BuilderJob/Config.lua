...
Config.OnePercentWorth = 20            -- Means that 1% progress will reward players with $100
...
Config.Blips = { -- Here you can configure Company blip.
    [1] = {
        ...
        Color = 0,
        Scale = 0.6,
        Pos = vector3(141.54,-379.8,43.25),
        Label = '[EMPREGO] Construtor'
    },
}
...
Config.SpawnPoint = vector4(136.54,-378.44,43.25,334.49)      -- Company car spawn point
Config.MixerSpawnPoint = vector4(130.48,-377.07,43.27,345.83)  -- Company Mixer Spawn Point
...
Config.Lang = {
    ...
    ["keybind"] = 'Interação com Marcador de Trabalho de Construção',
    ...
    ["wrongCar"] = "Este não é o veículo da sua empresa",
    ["CarNeeded"] = "Você precisa do veículo da empresa para finalizar o trabalho.",
    ["nobodyNearby"] = "Não há ninguém por perto",
    ["cantInvite"] = "Para convidar mais pessoas, você deve primeiro finalizar o trabalho",
    ["inviteSent"] = "Convite enviado!",
    ["spawnpointOccupied"] = "O local de spawn do carro ou caminhão betoneira está ocupado",
    ["pipesNotReady"] = "Antes de despejar o concreto, você deve instalar os canos",
    ["clickToPour"] = "~INPUT_CONTEXT~ para despejar o concreto",
    ["installPipe"] = "Instalar cano",
    ["pickupBlock"] = "Pegar bloco",
    ["tutorialAfterMixerPickup"] = "Você acabou de pegar a betoneira designada pelo seu chefe. Leve-a ao canteiro de obras e despeje o concreto nas áreas designadas. O canteiro de obras está marcado no GPS",
    ["startingTutorial"] = "Bem-vindo ao trabalho de construtor. Uma variedade de tarefas o aguarda no local, desde soldar, construir paredes, fazer drenos ou despejar concreto. Se estiver trabalhando em grupo, agora terão que se dividir: uma pessoa deve ser deixada no ponto de coleta da betoneira e transportá-la ao canteiro de obras. Cada atividade será explicada quando você se aproximar dela pela primeira vez. As localizações das tarefas estão marcadas no mapa. Se você trabalhar sozinho, terá que completar cada tarefa por conta própria; se trabalhar em grupos, vocês decidem como dividir. Você não precisa realizar todas as tarefas, pode terminar quando quiser, e seu pagamento depende de quantos % das tarefas você realizar. Desejamos boa sorte!",
    ["installBlock"] = "Construir parede",
    ["tutorialWallBuilding"] = "Você está ao lado da estrutura da parede, sua tarefa é construí-la usando blocos de concreto. Os blocos de concreto estão perto da estrutura e estão marcados no GPS. Caminhe até a pilha de blocos, pegue um e depois monte-o na parede",
    ["tutorialAboutPipes"] = "Você está ao lado de um buraco com vista para os canos de esgoto. Sua tarefa é instalar os canos nos locais corretos. Após instalar os canos, você deve despejar concreto sobre o buraco usando uma betoneira.",
    ["tutorialWelding"] = "Você está ao lado do local onde o chefe mandou você soldar algo. O trabalho é muito simples e não requer explicação adicional",
    ["startWelding"] = "Iniciar soldagem",
    ["workstationOccupied"] = "Esta estação de trabalho está ocupada",
    ["notFullJob"] = "Você precisa fazer 100% de progresso antes de encerrar o trabalho",
    ...
    ["HaveActiveInvite"] = "Você já tem um convite ativo para entrar em uma equipe.",
    ["InviteDeclined"] = "Seu convite foi recusado.",
    ["InviteAccepted"] = "Seu convite foi aceito!",
    ["error"] = "Houve um problema ao ingressar na equipe. Tente novamente mais tarde.",
    ...
    ["noMixerStatus"] = "Atualmente, não temos nenhuma betoneira disponível para você. Por favor, tente novamente mais tarde",
    ["dontHaveReqItem"] = "Você ou alguém da sua equipe não possuem o item necessário para iniciar o trabalho",
    ...
    ["minutes"] = "m",
    ["seconds"] = "s",
    ["newBoss"] = "O líder anterior saiu do servidor. Você agora é o líder da equipe",
...
Config.JobBlipsStyle = {
    ["mixerSpawnLocation"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Betoneira para coleta",
        sprite = 800,
    },
    ["mixerTargetLocation"] = {
        color = 47,
        string = "~o~[CONSTRUTOR]~s~ Local de entrega da betoneira",
        sprite = 652,
    },
    ["installPipe"] = {
        color = 47,
        string = "[BUILDER] Instalar tubo",
        sprite = nil,
    },
    ["blockPickup"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Blocos de coleta para construção de paredes",
        sprite = 655, 
    },
    ["buildWall"] = {
        color = 47,
        string = "~o~[CONSTRUTOR]~s~ Construir um muro",
        sprite = 285, 
    },

    ["welding"] = {
        color = 47,
        string = "~o~[CONSTRUTOR]~s~ Soldagem",
        sprite = 468, 
    },
}

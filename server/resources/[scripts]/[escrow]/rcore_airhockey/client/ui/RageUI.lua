...
L2_1.Id = nil
L3_1 = {}
L3_1.audioName = "HUD_FRONTEND_DEFAULT_SOUNDSET"
L3_1.audioRef = "NAV_UP_DOWN"
L2_1.UpDown = L3_1
L3_1 = {}
L3_1.audioName = "HUD_FRONTEND_DEFAULT_SOUNDSET"
L3_1.audioRef = "NAV_LEFT_RIGHT"
L2_1.LeftRight = L3_1
L3_1 = {}
L3_1.audioName = "HUD_FRONTEND_DEFAULT_SOUNDSET"
L3_1.audioRef = "SELECT"
L2_1.Select = L3_1
L3_1 = {}
L3_1.audioName = "HUD_FRONTEND_DEFAULT_SOUNDSET"
L3_1.audioRef = "BACK"
...
L3_1 = {}
L3_1.audioName = "HUD_FRONTEND_DEFAULT_SOUNDSET"
L3_1.audioRef = "CONTINUOUS_SLIDER"
L3_1.Id = nil
L2_1.Slider = L3_1
L1_1.Audio = L2_1
L2_1 = {}
...
L0_1 = RageUI
L0_1.LastInstructionalState = nil
L0_1 = RageUI
L0_1.LastInstructionalDevice = nil
L0_1 = RageUI
function L1_1()
  local L0_2, L1_2, L2_2, L3_2, L4_2, L5_2
  L0_2 = RageUI
  L0_2 = L0_2.CurrentMenu
  L0_2 = L0_2.ConfirmKey
  if L0_2 then
    L0_2 = RageUI
    L0_2 = L0_2.CurrentMenu
    L0_2 = L0_2.ConfirmKey
  ...
  L2_2[2] = L4_2
  L2_2[3] = L5_2
  L3_2 = PushNUIInstructionalButtons
  L4_2 = L2_2
  L3_2(L4_2)
end
L0_1.ShowInstructionalButtonsNUI = L1_1
L0_1 = RageUI
function L1_1()
  ...
  L1_2 = L1_2()
  L2_2 = RageUI
  L2_2 = L2_2.LastInstructionalState
  if L0_2 == L2_2 then
    L2_2 = RageUI
    L2_2 = L2_2.LastInstructionalDevice
    if L1_2 == L2_2 then
      goto lbl_43
    end
  end
  if L0_2 then
    ...
    if not L2_2 then
      L2_2 = RageUI
      L2_2 = L2_2.ShowInstructionalButtonsNUI
      L2_2()
  end
  else
    L2_2 = RageUI
    L2_2 = L2_2.WaitForClose
    if L2_2 then
      L2_2 = RageUI
      L2_2.WaitForClose = false
      L2_2 = PushNUIInstructionalButtons
      L3_2 = nil
      L2_2(L3_2)
    end
  end
  L2_2 = RageUI
  L2_2.LastInstructionalDevice = L1_2
  L2_2 = RageUI
  L2_2.LastInstructionalState = L0_2
  ::lbl_43::
end
L0_1.RefreshNUIInstructionalState = L1_1
L0_1 = RageUI
L0_1.WaitForClose = false
L0_1 = RageUI
...
function L1_1()
  ...
  if nil ~= L2_2 then
    ...
    L4_2 = L1_2.Background
    L4_2 = L4_2.Texture
    L5_2 = L0_2.X
    L6_2 = L0_2.Y
    L7_2 = L1_2.Background
    L7_2 = L7_2.Y
    L6_2 = L6_2 + L7_2
    L7_2 = L0_2.SubtitleHeight
    L6_2 = L6_2 + L7_2
    L7_2 = RageUI
    L7_2 = L7_2.ItemOffset
    L6_2 = L6_2 + L7_2
    L7_2 = L1_2.Background
    L7_2 = L7_2.Width
    L8_2 = L0_2.WidthOffset
    L7_2 = L7_2 + L8_2
    L8_2 = L0_2.DescriptionHeight
    L9_2 = 0
    L10_2 = 0
    L11_2 = 0
    L12_2 = 255
...
function L1_1(A0_2)
  ...
  if "" ~= A0_2 or nil ~= A0_2 then
    ...
    if L2_2 ~= A0_2 then
      ...
      L14_2 = false
      L15_2 = false
      L16_2 = L2_2.Background
      L16_2 = L16_2.Width
      L17_2 = L1_2.WidthOffset
      L17_2 = L17_2 - 5.0
      L16_2 = L16_2 + L17_2
      L3_2 = L3_2(L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2, L12_2, L13_2, L14_2, L15_2, L16_2)
      if L3_2 > 1 then
        L4_2 = L2_2.Background
        L4_2 = L4_2.Height
        L4_2 = L4_2 * L3_2
        L1_2.DescriptionHeight = L4_2
      else
        L4_2 = L2_2.Background
        L4_2 = L4_2.Height
        L4_2 = L4_2 + 7

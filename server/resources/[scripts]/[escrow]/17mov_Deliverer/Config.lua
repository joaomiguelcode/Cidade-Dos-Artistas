...
Config.Price = 150                                                  -- 100$ per one delivery
...
Config.Lang = {
    ...
    ["TargetCoords"] = "Destino do Entregador",
    ["deliverParcel"] = "Entregar o Pacote",
    ["takeParcel"] = "Pegar o pacote",
    ["wait"] = "Agora espere alguém abrir a porta",
    ["missingParcel"] = "Você não tem um pacote com você. Pegue-o no carro",
    ...
    ["tutorial"] = "O trabalho envolve entregar pacotes para as casas. Se você trabalhar em equipe, uma pessoa dirige o carro até o local designado, enquanto a outra pessoa pega o pacote no porta-malas e vai entregá-lo na casa. Se você trabalhar sozinho, terá que realizar ambas as tarefas por conta própria. O pagamento depende do número de pacotes entregues. Termine o trabalho quando quiser, retornando à base e deixando o carro no local designado",
    ["partyIsFull"] = "Falha ao enviar o convite, seu grupo está cheio",
    ["inviteSent"] = "Convite enviado!",
    ["tooFar"] = "Você está muito longe do local-alvo para pegar um pacote",

...
Config.VehicleDeposit = 100           -- Deposit for the car collected at the time of pulling out, and refunded when returning the car
...
Config.Locations = {                                            -- Here you can configure Markers Locations :D
    ...
    StoreVeh = {
        ...
        CurrentActionMsg = 'Pressione ~INPUT_CONTEXT~ para ~y~armazenar ~s~car.',
...
Config.Lang = {
    ...
    -- Cliente
    ["keybind"] = 'Interação com Marcador de Eletricista',
    ["hostSuccess"] = "Parabéns! Agora espere seu parceiro consertar o defeito.",
    ["wrongCar"] = "Você deve estar em um veículo da empresa para recuperar sua fiança!",
    ["AlreadyTaken"] = "Você ou alguém da equipe já pegou um veículo da empresa antes!",
    ["nobodyAround"] = "Não há pessoas por perto!",
    ["cantInvite"] = "Para convidar mais pessoas, você deve primeiro finalizar o trabalho",
    ["kicked"] = "Você expulsou %s da equipe",
    ["plyIsBusy"] = "Primeiro, complete o pedido anterior.",
    ["leftTeam"] = "Você saiu da equipe!",
    ["tooFar"] = "Sua equipe começou a trabalhar, mas você está muito longe da sede.",
    ["cantSpawn"] = "O local de spawn do caminhão está ocupado.",
    ["waitingForReady"] = "Aguardando o parceiro ficar pronto...",
    ["failedHostSide"] = "Seu parceiro falhou em consertar o defeito. Volte para a base para pegar outro pedido!",
    ["failedClientSide"] = "Você falhou em consertar o defeito. Volte para a base para pegar outro pedido!",
    ["doneHostSide"] = "Seu parceiro conseguiu consertar o defeito.",
    ["doneClientSide"] = "Você consertou o defeito com sucesso. Trabalho concluído.",
    ["dontGiveVehicle2ndTime"] = "Você não devolveu o carro anterior, então não daremos outro!",
    ["turnOffVoltage"] = "Desligue a voltagem",
    ["FixFault"] = "Consertar o Defeito",
    ["no_permission"] = "Somente o dono da equipe pode fazer isso",
    ["Leave"] = "Sair",
    ["walkedAway"] = "Seu parceiro desligou a voltagem, mas você se afastou do local. Volte para continuar",
    ...
    -- Servidor
    ['PromotionMedium'] = 'Parabéns! O chefe te promoveu na empresa. Agora você pode pegar pedidos médios!',
    ['PromotionHard'] = 'Parabéns! O chefe te promoveu na empresa. Agora você pode pegar pedidos difíceis!',
    ['Promotion'] = 'Parabéns! O chefe te promoveu na empresa. Agora você pode pegar pedidos difíceis!',
    ['ReturnDeposit'] = 'O depósito do proprietário do veículo foi devolvido!',
    ['Deposit'] = 'Depósitos de $500 foram coletados',
    ...
    ["RequireOneFriend"] = "Este trabalho requer um membro da equipe",
    ["dontHaveReqItem"] = "Você ou alguém da sua equipe não possui o item necessário para iniciar o trabalho",
    ["penalty"] = "Você pagou uma multa no valor de ",
    ["notEverybodyHasRequiredJob"] = "Nem todos os seus amigos têm o trabalho necessário",
    ["dontHaveMoney"] = "Você não tem dinheiro para pagar o depósito",

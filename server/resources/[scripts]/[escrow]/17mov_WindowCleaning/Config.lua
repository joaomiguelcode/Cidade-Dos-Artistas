...
Config.Blips = { -- Here you can configure Company blip.
    [1] = {
        ...
        Label = '[EMPREGO] Limpador de Janelas'
    },
}
...
Config.Lang = {
    ...
    ["keybind"] = 'Interação com o Marcador de Limpeza de Janelas',
    ...
    ["enterPlatform"] = "Entre na plataforma e comece o trabalho",
    ["exitPlatform"] = "Sair da Plataforma",
    ["cleanWindowInfo"] = "Pressione ~INPUT_CONTEXT~ para ~y~começar~s~ a limpar a janela",
    ...
    ["someoneIsAlreadyCleaning"] = "Alguém já está limpando esta janela",
    ...
    ["tutorial1"] = "O trabalho consiste em limpar as janelas de edifícios residenciais. A localização do seu trabalho atual foi designada. Vá para o local e comece o trabalho lá. Assim que você estiver no telhado, comece a limpar as janelas. Você pode parar de trabalhar quando quiser, seu pagamento depende de quantas janelas você limpar. Quando quiser encerrar o trabalho, retorne à base e devolva o carro da empresa. Quando terminar de limpar todas as janelas, você precisa ir até a base para receber seu pagamento.",
    ["tutorial2"] = "Você está na plataforma! Sua tarefa é limpar as janelas abaixo de você. O proprietário da equipe pode mover a plataforma com as setas do teclado. No topo, há um texto com o qual você pode sair da plataforma. Esta também é uma saída de emergência caso um dos membros da equipe caia. Usar este botão por uma pessoa transportará toda a equipe para baixo. Para contar a janela como limpa, você deve limpar pelo menos 95% da superfície.",
    ["partyIsFull"] = "Falha ao enviar o convite, seu grupo está cheio",
    ["inviteSent"] = "Convite Enviado!",
    ["youCanControl"] = "Algo deu errado com o seu líder de equipe. De agora em diante, você pode controlar a plataforma.",
    ["cantLeaveLobby"] = "Você não pode sair do lobby enquanto está trabalhando. Primeiro, encerre o trabalho.",
    ["targetLocation"] = "Local Alvo",
    ...
    ["emergencyStop"] = "Um membro da equipe ficou ferido. Nós o transportamos para baixo.",
    ["tooFar"] = "Um dos jogadores se afastou demais da plataforma. Nós o movemos para o fundo.",

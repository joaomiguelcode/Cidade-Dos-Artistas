...
Config.OneGasPercentWorth = 140                     -- How much script should pay for one percent of collected gas.
Config.OneQuestPercentWorth = 70                    -- How much script should pay for one percent of side quests done.
...
Config.PenaltyAmount = 0                          -- Penalty that is levied when a player finishes work without a company vehicle
...
Config.BlipsStyles = {
    ...
    EndJob = {
        label = "~b~[PLATAFORMA]~s~ Finalizar Trabalho",
        sprite = 1,
        scale = 1.0,
        color = 0,
    },
    ...
    Boat = {
        label = "~b~[PLATAFORMA]~s~ Localização do Barco",
        sprite = 1,
        scale = 1.0,
        color = 0,
    },
    Containers = {
        label = "~b~[PLATAFORMA]~s~ Contêiner para carregar",
        sprite = 1,
        scale = 0.6,
        color = 0,
    },
    Rig = {
        label = "~b~[PLATAFORMA]~s~ Plataforma",
        sprite = 1,
        scale = 1.0,
        color = 0,
    },
    CarryingProp = {
        label = "~b~[PLATAFORMA]~s~ Destino de Entrega",
        sprite = 1,
        scale = 1.0,
        color = 0,
    },
    Drilling = {
        label = "~b~[PLATAFORMA]~s~ Tarefa de Perfuração",
        sprite = 1,
        scale = 1.0,
        color = 0,
    },
    Welding = {
        label = "~b~[PLATAFORMA]~s~ Tarefa de Soldagem",
        sprite = 1,
        scale = 1.0,
        color = 0,
    },
...
Config.Lang = {
    -- Cliente
    ["no_permission"] = "Apenas o dono do grupo pode fazer isso!",
    ["keybind"] = 'Interação com Marcador de Trabalho na Plataforma de Petróleo',
    ...
    ["spawnpointOccupied"] = "O local de spawn do carro ou do navio está ocupado",
    ...
    ["lobby_joined"] = "Você entrou no lobby.",
    ["attach_prop"] = "Pressione ~INPUT_CONTEXT~ para anexar o contêiner",
    ["detach_prop"] = "Pressione ~INPUT_CONTEXT~ para desanexar o contêiner",
    ["crane_usage"] = "Use ~INPUT_MOVE_UP_ONLY~ ~INPUT_MOVE_DOWN_ONLY~ para mover o guindaste.~n~Use ~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ para mover a cabine.~n~Use ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ para mover o espargidor.~n~Use ~INPUT_NEXT_CAMERA~ para mudar a visão.~n~Pressione ~INPUT_FRONTEND_PAUSE_ALTERNATE~ para sair.",
    ["crane_attach"] = "Pressione ~INPUT_PICKUP~ para pegar os contêineres.",
    ["crane_detach"] = "Pressione ~INPUT_PICKUP~ para soltar os contêineres.",
    ["press_to_pickup"] = "Pressione ~INPUT_CONTEXT~ para pegar.",
    ["open_container"] = "Pressione ~INPUT_CONTEXT~ para abrir o contêiner.",
    ["put_down"] = "Pressione ~INPUT_CONTEXT~ para largar.",
    ["load_container_on_boat"] = "Carregue o contêiner no barco",
    ["startingTutorial"] = "Bem-vindo ao seu trabalho na plataforma de petróleo. Sua missão é extrair o máximo de gás possível, além de concluir várias tarefas secundárias. Comece carregando contêineres no seu navio. Usando o veículo de carga, levante um contêiner e coloque-o no navio. Mais instruções serão exibidas durante o seu turno. Vamos começar a perfurar!",
    ["loaded_tutorial"] = "Parece que todos os contêineres foram carregados. Marcamos sua plataforma de perfuração no mapa. Coloque toda a tripulação a bordo do navio e vá para a plataforma. Quando chegar, ancore seu navio no local designado",
    ["rig_tutorial"] = "Suba até o topo da plataforma usando as escadas. Quando estiver lá em cima, você pode começar a realizar as tarefas, mas não se esqueça de descarregar os contêineres. Use o guindaste designado para isso. Entre no guindaste, e mais instruções aparecerão. Vamos trabalhar e fazer esta plataforma funcionar perfeitamente",
    ["craneTutorial"] = "Pegue o elevador até o nível onde o barco está estacionado. Levante um contêiner e coloque-o no local designado. Repita esse processo com todos os contêineres",
    ["afterLoadTutorial"] = "Parece que todos os contêineres foram descarregados. Agora, sua tarefa é distribuir o conteúdo. Aproxime-se das portas para abri-las e distribua todos os itens nos locais designados",
    ["drill_tutorial"] = "Você se aproximou da máquina de extração de gás. Vamos explicar rapidamente sua tarefa. Você precisa continuar perfurando tubos cada vez mais fundo até atingir 100% de extração. Cuidado: você pode aumentar até 150% de extração de gás, mas cada perfuração adicional aumenta o risco de explosão. Se o gás explodir, você perderá todo o gás coletado e não será possível continuar o trabalho. Trabalhe com cuidado e faça escolhas estratégicas!",
    ["props_tutorial"] = "Agora, você precisa distribuir todo o conteúdo do contêiner nos locais designados. Pegue um item e o local de destino será destacado",
    ["rig_exploded"] = "A máquina explodiu, resultando na perda de todo o progresso. Você não pode continuar perfurando",
    ["not_in_boat"] = "Você não está no barco!",
    ["drill_busy"] = "A perfuradora está ocupada no momento. Tente novamente mais tarde",
    ["endJobHint"] = "Pressione ~INPUT_CONTEXT~ para ~y~encerrar ~s~o trabalho.",
    ["noBoatLocation"] = "Não há locais livres para o barco",
    ["noHandlerLocation"] = "Não há locais livres para o manipulador",
    ["noContainerLocation"] = "Não há locais livres para o contêiner",
    ["noRig"] = "Não há trabalho disponível para fazer",
    ["endJob"] = "Pressione ~INPUT_CONTEXT~ para ~y~encerrar ~s~o trabalho.",

    -- Servidor
    ["isAlreadyHost"] = "Este jogador lidera sua equipe.",
    ["isBusy"] = "Este jogador já pertence a outro grupo.",
    ...
    ["dontHaveReqItem"] = "Você ou alguém da sua equipe não possui o item necessário para começar o trabalho",
    ["notEverybodyHasRequiredJob"] = "Nem todos os seus amigos têm o trabalho necessário",
    ["someoneIsOnCooldown"] = "%s não pode iniciar o trabalho agora (tempo de espera: %s)",
    ["hours"] = "h",
    ["minutes"] = "m",
    ["seconds"] = "s",
    ["newBoss"] = "O líder anterior do lobby saiu do servidor. Agora você é o líder da equipe",
    ["wait"] = "Por favor, aguarde alguns segundos e tente novamente mais tarde",
    ["craneBusy"] = "Guindaste está ocupado. Por favor, tente novamente mais tarde",

    -- NUI
    ["NUI_weldingJobTitle"] = "Soldagem",
    ["NUI_weldingJobTitlePlaceholder"] = "MINIGAMES",
    ["NUI_instructionWeldingContent"] = "Sua tarefa é realizar um trabalho de soldagem na linha indicada. Execute com a maior precisão possível, pois o sucesso depende inteiramente da sua precisão. Lembre-se, há um limite de tempo para concluir essa tarefa. Para começar, pressione a barra de espaço ou o botão na parte inferior da interface.",
    ["NUI_pipesJobTitle"] = "Perfuração",
    ["NUI_pipesJobPlaceholder"] = "MINIGAMES",
    ["NUI_instructionPipesContent"] = "Sua tarefa é conectar o tubo anterior com o próximo. Para tentar conectar o tubo, pressione a barra de espaço. Se os tubos estiverem muito distantes um do outro, o mini-jogo não será considerado bem-sucedido. Você deve fazer isso até atingir 100% de extração. Cuidado: você pode aumentar até 150% de extração de gás, mas cada perfuração adicional aumenta o risco de explosão. Se o gás explodir, você perderá todo o gás coletado, e não será possível continuar o trabalho. Para começar, pressione a barra de espaço ou o botão na parte inferior da interface.",
    ["NUI_instructionTitle"] = "Instrução",
    ["NUI_timeTitle"] = "Tempo",
    ["NUI_timeContentPrimary"] = "Tempo para acabar...",
    ["NUI_tasksTitle2"] = "Número de tarefas",
    ["NUI_tasksContentPrimary2"] = "Tarefas restantes...",
    ["NUI_tasksContentSecondary2"] = "%s/%s tarefas",
    ["NUI_tasksTitle"] = "Progresso Atual de Gás",
    ["NUI_tasksContentPrimary"] = "Gás Coletado...",
    ["NUI_tasksContentSecondary"] = "%s%",
    ["NUI_progress"] = "Progresso: %s%",
    ["NUI_gasProgress"] = "Gás Coletado: %s%",
    ["NUI_startTitle"] = "Iniciar",
    ["NUI_buttonStart"] = "Iniciar",
    ["NUI_buttonFinish"] = "Terminar",
    ["NUI_buttonAgain"] = "Tentar novamente",
    ["NUI_buttonExit"] = "Sair",
    ["NUI_notifySuccess"] = "Tarefa concluída",
    ["NUI_notifyFailed"] = "Tarefa falhou",
    ["NUI_signatureTitle"] = "TRABALHO NA PLATAFORMA DE PETRÓLEO",
    ["NUI_signatureTitlePlaceholder"] = "TRABALHO NA PLATAFORMA DE PETRÓLEO",
    ["NUI_signatureSubtitle"] = "Documento de Assinatura",
    ["NUI_signatureText"] = "Para largar o objeto, assine este documento primeiro",
    ["NUI_signatureError"] = "Você precisa assinar!",
    ["NUI_signatureAccept"] = "Assinar",
    ["NUI_signatureRetry"] = "Limpar",
    ...
    ["NUI_kickPlayerNotify"] = "O dono da equipe não pode sair dela!",
    ["NUI_startJobNotify"] = "Apenas o dono do grupo pode iniciar o trabalho!",
    ["NUI_oilRigLobby"] = "LOBBY DA PLATAFORMA DE PETRÓLEO",
}

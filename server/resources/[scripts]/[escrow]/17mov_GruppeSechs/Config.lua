...
Config.Reward = 3000                    -- Complete transport will give the team this value. 
...
Config.HeistVehBlipSettings = {
    ...
    color = 43,
    scale = 0.8,
    label = "Caminhão de assalto alvo",
...
Config.Lang = {
    ...
    -- Cliente
    ["no_permission"] = "Somente o líder da equipe pode fazer isso!",
    ["keybind"] = 'Interação com Marcador',
    ["too_far"] = "Sua equipe começou a trabalhar, mas você está muito longe da sede.",
    ["kicked"] = "Você expulsou %s da equipe",
    ["alreadyWorking"] = "Primeiro, complete o pedido anterior",
    ["quit"] = "Você saiu da equipe",
    ["wrongCar"] = "Este não é o seu veículo da empresa",
    ["CarNeeded"] = "Você precisa do veículo da empresa para terminar o trabalho.",
    ["nobodyNearby"] = "Não há ninguém por perto",
    ["cantInvite"] = "Para convidar mais pessoas, você deve primeiro finalizar o trabalho",
    ["cantInviteCrime"] = "Para convidar mais pessoas, você deve primeiro terminar o assalto",
    ["inviteSent"] = "Convite enviado!",
    ["spawnpointOccupied"] = "O local de spawn do carro está ocupado",
    ["enterCode"] = "Digite o código",
    ["grabMoney"] = "Comece a pegar o dinheiro",
    ["srcBank"] = "Banco de origem",
    ["targetBank"]  = "Banco de destino",
    ["notAllBags"] = "Sua equipe não entregou todos os sacos!",
    ["throwBag"] = "Jogar saco",
    ["notEverythingDone"] = "Você não pegou todo o dinheiro!",
    ["someonesInside"] = "Alguém está dentro do cofre! Você não pode trancá-lo",
    ["startingTutorial"] = "O trabalho envolve transportar dinheiro do banco de origem ou local, para o banco de destino. Vá até o local designado para mais informações. Lembre-se de que este é um trabalho perigoso, você pode esperar várias tentativas de assalto.",
    ["beforeMoneyGrabInBank"] = "Seu primeiro passo é coletar o dinheiro dos carrinhos no cofre. Você não pode perder uma única cédula, nem deixar alguém trancado no cofre. Não se esqueça de fechar a porta do cofre quando sair",
    ["beforeMoneyGrab"] = "Seu primeiro passo é coletar o dinheiro dos carrinhos. Você não pode perder uma única cédula, depois que pegar tudo, os próximos passos serão explicados",
    ["afterMoneyGrabTutorialInBank"] = "Você pegou todo o dinheiro do cofre. Agora feche a porta do cofre e depois coloque os sacos de dinheiro no porta-malas do carro. Siga os procedimentos, se não colocar os sacos, você não conseguirá mover o carro.",
    ["afterMoneyGrabTutorial"] = "Você pegou todo o dinheiro dos carrinhos. Agora coloque os sacos de dinheiro no porta-malas do carro. Siga os procedimentos, se não colocar os sacos, você não conseguirá mover o carro.",
    ["afterBagLoadingTutorial"] = "Sacos carregados. A partir de agora, você pode mover o veículo. Vá até o local marcado para entregar os sacos!",
    ["afterDeliveringBagsTutorial"] = "Você entregou os sacos no cofre. Aqui termina seu trabalho. Feche a porta do cofre e vá até a base para receber o pagamento",
    ["AfterArrivalToTargetBank"] = "Você chegou ao banco de destino, desbloqueamos a possibilidade de abrir a porta traseira. Vá até a parte de trás do carro para abrir a porta, pegar os sacos e levá-los ao cofre",
    ["afterAttack"] = "Você foi atacado. Seu dinheiro provavelmente será roubado. Não continue o trabalho, retorne à base",
    ["notReadyWarning"] = "O trabalho não foi concluído. Você pode sair do serviço agora, mas será cobrada uma multa e seu pagamento não será feito.",
    ["wrongCarWarning"] = "Este não é o carro da empresa. Você ainda pode terminar o trabalho, mas será cobrada uma multa",
    ["cantOpenTabletWhileOnDuty"] = "Você não pode abrir este tablet enquanto estiver em serviço",
    ["alreadyBusy"] = "Você não pode iniciar um assalto porque está em serviço ou já está realizando um assalto",
    ["tooLate"] = "O transporte com o dinheiro chegou ao local. Você chegou tarde demais",
    ["endJob"] = "Finalizar Trabalho",
    ["afterStartingHeist"] = "Sua equipe iniciou um assalto a um carregamento de dinheiro. Aqueles com um tablet podem abri-lo agora, nele estão escritos todos os passos que você precisa seguir para roubar o caminhão. Você precisa se apressar, assim que o caminhão se aproximar do banco, sua chance se foi.",
    ["startingFetching"] = "O tablet está se conectando ao caminhão... Não se afaste do caminhão para evitar interromper a conexão",
    ["deliveryLocation"] = "Entregar Sacos Aqui",
    ["copsNotification"] = "Atividade suspeita em torno do transporte de dinheiro foi detectada. Verifique - local marcado no GPS",
    ["didntMakeThirdStep"] = "Você não pegou o saco do caminhão",
    ["notADriver"] = "Você precisa ser o motorista do veículo para terminar o trabalho",
    ["atmBlip"] = "Reabasteça o caixa eletrônico",
    ["deliverCash"] = "Entregue o dinheiro ao guarda",
    ...
    ["dontForgetDoors"] = "Não se esqueça de fechar as portas do cofre!",
    ["cantLeaveLobby"] = "Você não pode sair do lobby enquanto está trabalhando. Primeiro, termine o trabalho.",
    ...
    ["noFreeLocations"] = "Atualmente não temos pedidos para você",
    ["notEnoughClients"] = "Você não tem membros suficientes na equipe para iniciar um assalto",
    ["notEnoughPolice"] = "Não há policiais suficientes de plantão na cidade",
    ...
    ["alreadyInLegalParty"] = "Este jogador já está trabalhando em outro lugar",

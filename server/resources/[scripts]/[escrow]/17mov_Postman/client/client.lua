...
L4_1 = 0
L5_1 = {}
L6_1 = GetPlayerServerId
L7_1 = PlayerId
L7_1, L8_1, L9_1, L10_1, L11_1, L12_1, L13_1, L14_1, L15_1, L16_1, L17_1, L18_1, L19_1 = L7_1()
...
L12_1 = "17mov_postman:UpdateHostPercentages"
function L13_1(A0_2)
  local L1_2, L2_2
  L1_2 = SendNUIMessage
  L2_2 = {}
...
L11_1(L12_1, L13_1)
L11_1 = RegisterNetEvent
L12_1 = "17mov_postman:SetMyReward"
function L13_1(A0_2)
  local L1_2, L2_2
  L1_2 = SendNUIMessage
  L2_2 = {}
...
L11_1(L12_1, L13_1)
L11_1 = Config
L11_1 = L11_1.letBossSplitReward
if L11_1 then
  L11_1 = RegisterNUICallback
  L12_1 = "checkIfThisRewardIsFine"
  function L13_1(A0_2, A1_2)
    ...
    L5_2 = "17mov_postman:CheckThisReward"
    function L6_2(A0_3)
      local L1_3, L2_3
      if A0_3 then
        L1_3 = A1_2
...
L11_1 = RegisterNetEvent
L12_1 = "17mov_postman:clearMyLobby"
function L13_1()
  local L0_2, L1_2, L2_2
  L0_2 = {}
  L5_1 = L0_2
  L0_2 = TriggerServerCallback
  L1_2 = "17mov_postman:init"
  function L2_2(A0_3)
...
TriggerServerCallback = L11_1
L11_1 = RegisterNetEvent
L12_1 = "17mov_Callbacks:receiveData"
    ...
    while true do
      ...
      if "none" == L9_2 then
        ...
        if L3_2 then
          ...
          if L9_2 then
            ...
            if L9_2 then
              ...
              if L9_2 then
                ...
                L9_2 = TriggerEvent
                L10_2 = "17mov_postman:ExitedMarker"
                L11_2 = LastStation
                L12_2 = LastPart
                L13_2 = LastPartNum
          ...
          LastPartNum = L8_2
          L9_2 = TriggerEvent
          L10_2 = "17mov_postman:EnteredMarker"
          L11_2 = L7_2
          L9_2(L10_2, L11_2)
        end
        ::lbl_249::
    ...
    while true do
      ...
      if "none" == L8_2 then
        ...
        if L2_2 then
          ...
          if L8_2 then
            ...
            if L8_2 then
              ...
              if L8_2 then
                ...
                L8_2 = TriggerEvent
                L9_2 = "17mov_postman:ExitedMarker"
                L10_2 = LastStation
                L11_2 = LastPart
                L12_2 = LastPartNum
          ...
          LastPartNum = L7_2
          L8_2 = TriggerEvent
          L9_2 = "17mov_postman:EnteredMarker"
          L10_2 = L6_2
          L8_2(L9_2, L10_2)
        end
        ::lbl_490::
...
InitalizeScript = L13_1
L13_1 = RegisterNetEvent
L14_1 = "QBCore:Client:OnPlayerLoaded"
function L15_1()
  local L0_2, L1_2
...
L13_1(L14_1, L15_1)
L13_1 = RegisterNetEvent
L14_1 = "QBCore:Client:OnJobUpdate"
L13_1(L14_1)
...
L13_1(L14_1, L15_1)
L13_1 = AddEventHandler
L14_1 = "17mov_postman:EnteredMarker"
function L15_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = Config
  L1_2 = L1_2.Locations
...
L13_1(L14_1, L15_1)
L13_1 = AddEventHandler
L14_1 = "17mov_postman:ExitedMarker"
function L15_1(A0_2)
  local L1_2
  CurrentAction = nil
...
L14_1 = "+postmanStartMarkerAction"
function L15_1()
  local L0_2, L1_2
end
L13_1(L14_1, L15_1)
  ...
  if nil ~= L0_2 then
    ...
    if "open_dutyToggle" == L0_2 then
      ...
      if "finish_job" == L0_2 then
        L0_2 = TriggerServerCallback
        L1_2 = "17mov_postman:IfPlayerIsHost"
        function L2_2(A0_3)
          local L1_3, L2_3
          if A0_3 then
            L1_3 = EndJob
...
L14_1(L15_1, L16_1)
L14_1 = TriggerEvent
L15_1 = "chat:removeSuggestion"
L16_1 = "/+postmanStartMarkerAction"
L14_1(L15_1, L16_1)
L14_1 = TriggerEvent
L15_1 = "chat:removeSuggestion"
L16_1 = "/-postmanStartMarkerAction"
...
L15_1 = "+postmanStartMarkerAction"
L16_1 = Config
L16_1 = L16_1.Lang
L16_1 = L16_1.keybind
L17_1 = "keyboard"
  ...
  function L15_1()
    ...
    function L4_2()
      ...
      while true do
        ...
        L5_3 = "17mov_postman:GetPlayersNames"
        function L6_3(A0_4)
...
function L18_1(A0_2, A1_2)
  ...
  L6_2 = "17mov_postman:IfPlayerIsHost"
  function L7_2(A0_3)
    local L1_3, L2_3, L3_3, L4_3
    if A0_3 then
      L1_3 = TriggerServerCallback
      L2_3 = "17mov_postman:GetPlayersNames"
      function L3_3(A0_4)
        local L1_4, L2_4
        L1_4 = A1_2
        L2_4 = A0_4
...
L16_1(L17_1, L18_1)
L16_1 = RegisterNUICallback
L17_1 = "requestReacted"
function L18_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L1_2 = A0_2.boolean
  L2_2 = TriggerServerEvent
  L3_2 = "17mov_postman:ClientReactRequest"
  L4_2 = L1_2
  L2_2(L3_2, L4_2)
end
L16_1(L17_1, L18_1)
...
function L18_1(A0_2)
  ...
  L1_2 = TriggerServerEvent
  L2_2 = "17mov_postman:SendRequestToClient_sv"
  L3_2 = tonumber
  L4_2 = A0_2.id
  L3_2, L4_2 = L3_2(L4_2)
  L1_2(L2_2, L3_2, L4_2)
...
function L18_1(A0_2)
  ...
  L2_2(L3_2, L4_2, L5_2)
  L2_2 = TriggerServerEvent
  L3_2 = "17mov_postman:KickPlayerFromLobby"
  L4_2 = L1_2
  L5_2 = true
  L2_2(L3_2, L4_2, L5_2)
end
...
L17_1 = "17mov_postman:SendRequestToClient_cl"
L16_1(L17_1)
...
L16_1(L17_1, L18_1)
L16_1 = Config
L16_1 = L16_1.useModernUI
if L16_1 then
  L16_1 = RegisterNetEvent
  L17_1 = "17mov_postman:RefreshMugs"
  L16_1(L17_1)
  L16_1 = AddEventHandler
  L17_1 = "17mov_postman:RefreshMugs"
  function L18_1(A0_2, A1_2)
    ...
    L3_2 = TriggerServerCallback
    L4_2 = "17mov_postman:IfPlayerOwnsTeam"
    function L5_2(A0_3)
      local L1_3, L2_3
      L1_3 = SendNUIMessage
      L2_3 = {}
  ...
  function L18_1(A0_2, A1_2)
    ...
    L3_2 = "17mov_postman:IfPlayerIsHost"
    function L4_2(A0_3)
      local L1_3, L2_3
      L1_3 = SendNUIMessage
      L2_3 = {}
...
function L18_1(A0_2)
  ...
  if not L1_2 then
    ...
    if L1_2 then
      L1_2 = TriggerServerEvent
      L2_2 = "17mov_postman:StartJob_sv"
      L1_2(L2_2)
    else
      L1_2 = Notify
      L2_2 = Config
...
SpawnVehicle = L16_1
L16_1 = RegisterNetEvent
L17_1 = "17mov_postman:StartJob_cl"
L16_1(L17_1)
L16_1 = AddEventHandler
L17_1 = "17mov_postman:StartJob_cl"
function L18_1(A0_2, A1_2, A2_2, A3_2)
  ...
  L4_2 = Config
  L4_2 = L4_2.EnableVehicleTeleporting
  ...
  if A0_2 == A1_2 and not A3_2 then
    ...
    L6_2 = "17mov_postman:uploadJobVehicle"
    L7_2 = VehToNet
    L8_2 = L4_2
    ...
    while true do
      ...
      if L5_2 then
        L5_2 = TriggerServerCallback
        L6_2 = "17mov_postman:getPartyVeh"
        function L7_2(A0_3)
  ...
  if not A3_2 then
    ...
    L5_2 = "17mov_Tutorials:"
    L6_2 = "postmanTutorial"
    L5_2 = L5_2 .. L6_2
    L4_2 = L4_2(L5_2)
    if 0 == L4_2 then
      L4_2 = "postmanTutorial"
      L8_1 = L4_2
      L4_2 = SetNuiFocus
      L5_2 = true
      L6_2 = true
  ...
  if not A3_2 then
    L4_2 = SendNUIMessage
    L5_2 = {}
    L5_2.action = "updateCounter"
    L5_2.value = 0
    L4_2(L5_2)
  end
  L4_2 = SendNUIMessage
  L5_2 = {}
  L5_2.action = "showCounter"
  L4_2(L5_2)
  L4_2 = Config
  L4_2 = L4_2.UseTarget
  if not L4_2 then
...
function L17_1(A0_2)
  ...
  if L2_2 == L3_2 then
    if A0_2 > 0 then
      ...
      L5_2(L6_2, L7_2)
      L5_2 = TriggerServerEvent
      L6_2 = "17mov_postman:collectLetter"
...
L17_1(L18_1, L19_1)
L17_1 = RegisterNetEvent
L18_1 = "17mov_postman:updateCounter"
function L19_1(A0_2)
  local L1_2, L2_2
  L1_2 = SendNUIMessage
  L2_2 = {}

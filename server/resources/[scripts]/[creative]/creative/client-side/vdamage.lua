...
-- THREADHEALTHVEH
-----------------------------------------------------------------------------------------------------------------------------------------
local THREAD_HEALTH_VEH_STATUS
local HEALTH_VEH_CLASSES <const> = {
	['13'] = true,
	['14'] = true
}

local function threadHealthVehStatus()
	if THREAD_HEALTH_VEH_STATUS then return end

	local Classes = tostring(GetVehicleClass(cache.vehicle))
	if HEALTH_VEH_CLASSES[Classes] then return end

	THREAD_HEALTH_VEH_STATUS = true

...
AddEventHandler("tattoos:Apply",function(status)
	...
	if GetEntityModel(Ped) == `mp_m_freemode_01` or GetEntityModel(Ped) == `mp_f_freemode_01` then
		Tattoos = status
		ClearPedDecorations(Ped)
	
		for Hash,v in pairs(Tattoos) do
			SetPedDecoration(Ped,GetHashKey(v[1]),GetHashKey(Hash))
		end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- TATTOOS:OPEN
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("tattoos:Open")
AddEventHandler("tattoos:Open",function()
	openTattooShop()
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- OPENTATTOOSHOP
...
local Locations = {
	...
	{ 794.27,-1648.6,31.46 }, -- MOTOCLUB
	{ -1827.09,3244.5,36.8 }, -- exerciito
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------

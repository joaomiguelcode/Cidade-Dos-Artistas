...
Cfg.strings = {
    ...
    menuTitle       = "Jaguaré Cam",
    menuSubtitle    = "Privilegio criadores de conteudo",

    toggleCam       = "Câmera ativa",
    toggleCamDesc   = "Ativar/desativar a câmera",

    precision       = "Precisão da câmera",
    precisionDesc   = "Mude o movimento de precisão da câmera",

    filter          = "Filtros",
    filterDesc      = "Alterar filtro da câmera",

    filterInten     = "Intensidade do filtro",
    filterIntenDesc = "Alterar intensidade do filtro da câmera",
    
    delFilter       = "Redefinir filtro",
    delFilterDesc   = "Remova o filtro e redefina os valores",

    showMap         = "Mostrar Minimapa",
    showMapDesc     = "Ativar/desativar o minimapa",

    freeFly         = "Alternar modo de vôo livre",
    freeFlyDesc     = "Mude para Free Fly ou volte para o modo Drone",

    charControl     = "Alternar Controle de Personagem",
    charControlDesc = "Alternar para personagem ou voltar para o controle da câmera",

    attachCam       = "Conecte a câmera a:",
    attachCamDesc   = "Anexe a câmera a uma entidade na frente dela",

    pointEntity     = "Aponte a câmera para a entidade",
    pointEntityDesc = "Alternar apontar para a entidade selecionada",

    ctrlHelpRoll    = "Role para a esquerda/direita",
    ctrlHelpMove    = "Movimento",
    ctrlHelpRotate  = "Girar"
}

...
-- =======================================================
-- LISTENERS DE EVENTOS DE REDE (COMUNICAÇÃO COM O SERVIDOR)
-- =======================================================

RegisterNetEvent("0r-textui:client:displayTextUI", function(text, key, hide)
    displayTextUI(text, key, hide)
end)
RegisterNetEvent("0r-textui:displayTextUI", function(text, key, hide)
    displayTextUI(text, key, hide)
end)

RegisterNetEvent("0r-textui:client:hideTextUI", function()
    hideTextUI()
end)
RegisterNetEvent("0r-textui:hideTextUI", function()
    hideTextUI()
end)

RegisterNetEvent("0r-textui:client:changeText", function(text, key)
    changeText(text, key)
end)
RegisterNetEvent("0r-textui:changeText", function(text, key)
    changeText(text, key)
end)

RegisterNetEvent("0r-textui:client:create3DTextUI", function(id, data)
    create3DTextUI(id, data)
end)
RegisterNetEvent("0r-textui:create3DTextUI", function(id, data)
    create3DTextUI(id, data)
end)

RegisterNetEvent("0r-textui:client:delete3DTextUI", function(id)
    delete3DTextUI(id)
end)
RegisterNetEvent("0r-textui:delete3DTextUI", function(id)
    delete3DTextUI(id)
end)

RegisterNetEvent("0r-textui:client:update3DTextUI", function(id, text, theme)
    update3DTextUI(id, text, theme)
end)
RegisterNetEvent("0r-textui:update3DTextUI", function(id, text, theme)
    update3DTextUI(id, text, theme)
end)

RegisterNetEvent("0r-textui:client:create3DTextUIOnPlayers", function(id, data)
    create3DTextUIOnPlayers(id, data)
end)
RegisterNetEvent("0r-textui:create3DTextUIOnPlayers", function(id, data)
    create3DTextUIOnPlayers(id, data)
end)

RegisterNetEvent("0r-textui:client:delete3DTextUIOnPlayers", function(id)
    delete3DTextUIOnPlayers(id)
end)
RegisterNetEvent("0r-textui:delete3DTextUIOnPlayers", function(id)
    delete3DTextUIOnPlayers(id)
end)

RegisterNetEvent("0r-textui:client:create3DTextUIOnEntity", function(id, data)
    create3DTextUIOnEntity(id, data)
end)
RegisterNetEvent("0r-textui:create3DTextUIOnEntity", function(id, data)
    create3DTextUIOnEntity(id, data)
end)

-- Sincronização de Textos 3D Globais ativos no servidor
RegisterNetEvent("0r-textui:client:sync3DTexts", function(globalTexts)
    if globalTexts and type(globalTexts) == "table" then
        for id, data in pairs(globalTexts) do
            create3DTextUI(id, data)
        end
    end
end)

-- Solicita sincronização com o servidor
Citizen.CreateThread(function()
    Citizen.Wait(1000)
    TriggerServerEvent("0r-textui:server:requestSync")
end)